            ...
            {!loading && (
              user ? (
                <>
                  <Link
                    to="/create"
                    className="flex items-center gap-2 bg-blue-50 text-blue-600 hover:bg-blue-100 font-semibold py-2 px-4 rounded-xl transition-all duration-200 text-sm"
                  >
                  ...
                  <Link
                    to="/profile"
                    className="flex items-center gap-2 pl-2 border-l border-slate-100 hover:opacity-80 transition-opacity"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 text-slate-500 hover:text-slate-700 font-semibold py-2 px-3 rounded-xl transition-all duration-200 text-sm cursor-pointer"
                  >
