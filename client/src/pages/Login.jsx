...
const Login = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-6 py-16 bg-white selection:bg-amber-100 selection:text-amber-900">
      <motion.div 
      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-xl font-black text-zinc-950 tracking-tight">Welcome Back</h2>
          <p className="text-zinc-500 text-xs mt-2 font-medium">
            Log in to manage your publications and publish your stories.
          </p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-zinc-200 text-center text-xs font-semibold text-zinc-400 uppercase tracking-wider">
          ...
          <Link to="/signup" className="text-zinc-800 hover:text-brand font-black transition-colors ml-1">
            Sign Up
          </Link>
        </div>
      </motion.div>
